...
namespace CapaNegocio.ServiceReferenceWfcAlumnos {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceReferenceWfcAlumnos.IWCFAlumnos")]
    public interface IWCFAlumnos {
        ...
        CapaNegocio.ServiceReferenceWfcAlumnos.ItemTablaIsr CalcularIsr(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWCFAlumnos/CalcularIsr", ReplyAction="http://tempuri.org/IWCFAlumnos/CalcularIsrResponse")]
        System.Threading.Tasks.Task<CapaNegocio.ServiceReferenceWfcAlumnos.ItemTablaIsr> CalcularIsrAsync(int id);
        ...
        CapaNegocio.ServiceReferenceWfcAlumnos.AportacionesImss CalcularImss(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWCFAlumnos/CalcularImss", ReplyAction="http://tempuri.org/IWCFAlumnos/CalcularImssResponse")]
        System.Threading.Tasks.Task<CapaNegocio.ServiceReferenceWfcAlumnos.AportacionesImss> CalcularImssAsync(int id);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IWCFAlumnosChannel : CapaNegocio.ServiceReferenceWfcAlumnos.IWCFAlumnos, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WCFAlumnosClient : System.ServiceModel.ClientBase<CapaNegocio.ServiceReferenceWfcAlumnos.IWCFAlumnos>, CapaNegocio.ServiceReferenceWfcAlumnos.IWCFAlumnos {
        ...
        public CapaNegocio.ServiceReferenceWfcAlumnos.ItemTablaIsr CalcularIsr(int id) {
            return base.Channel.CalcularIsr(id);
        }
        
        public System.Threading.Tasks.Task<CapaNegocio.ServiceReferenceWfcAlumnos.ItemTablaIsr> CalcularIsrAsync(int id) {
            return base.Channel.CalcularIsrAsync(id);
        }
        
        public CapaNegocio.ServiceReferenceWfcAlumnos.AportacionesImss CalcularImss(int id) {
            return base.Channel.CalcularImss(id);
        }
        
        public System.Threading.Tasks.Task<CapaNegocio.ServiceReferenceWfcAlumnos.AportacionesImss> CalcularImssAsync(int id) {
