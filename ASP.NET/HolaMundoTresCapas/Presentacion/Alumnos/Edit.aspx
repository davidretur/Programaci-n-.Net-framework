...
<asp:RangeValidator ID="rvSueldo" runat="server" ControlToValidate="textSueldo"
    MinimumValue="9999" MaximumValue="39999"
    ...
    <br />
<div class="mb-3">
    <asp:Button ID="btnActualizar" runat="server" Text="Actualizar" CssClass="btn btn-sm btn-primary" OnClick="btnActualizar_Click" />
 </div> 
</div>
</div>
</div>
